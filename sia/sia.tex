...
at production low volume. The ethical implications include a minimal
likelihood chance of abuse of genetic information, though it's
consideration is important. The device faces little to no regulation
...
specific manufacturers. Additionally, the device could also generalize
to other use cases such as archaeologists with delicate bone
samples. These populaces would benefit from use of the device
similarly to the ophthalmological scientists it is targeted at.
...
knowledge, the potential for abuse exists.  Fortunately, enabling
