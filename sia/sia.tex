...
Five possible impacts the device may have on society are
...
as well as the public abuse of genetic information, and the device
faces little to no minimal regulation by the Food and Drug
Administration and local research facilities. In general, the device
benefits society by presenting an investment whose proper use may lead
to previously undiscovered treatments or to new avenues of research
...
while helping researchers conduct their research better and
...
money, for both researchers and organizations that fund them like the
...
manner. It not only requires minimal regulation and leaves a minimal
ecological footprint, but it also acts as a cost- and time-saving
long-term investment for ophthalmological researchers and possibly for
